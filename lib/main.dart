...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> initPlatformState() async {
    ...
    await OneSignal.shared
        .setAppId("b8fe2448-8644-4c12-9320-ebe522506219");
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                        ...
                        style: GoogleFonts.mochiyPopOne(textStyle: TextStyle(fontSize: 40,color: Colors.white,fontWeight: FontWeight.w600,))
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                        ...
                        textAlign: TextAlign.center,
                        style: GoogleFonts.mochiyPopOne(textStyle: TextStyle(fontSize: 14,color: Colors.white,fontWeight: FontWeight.w600,))
